...
int compute(taco_tensor_t *out, taco_tensor_t *mtx_covtypesparse_0, taco_tensor_t *vec_rand) {
  ...
  int mtx_covtypesparse_01_dimension = (int)(mtx_covtypesparse_0->dimensions[0]);
  int* restrict mtx_covtypesparse_02_pos = (int*)(mtx_covtypesparse_0->indices[1][0]);
  int* restrict mtx_covtypesparse_02_crd = (int*)(mtx_covtypesparse_0->indices[1][1]);
  int32_t* restrict mtx_covtypesparse_0_vals = (int32_t*)(mtx_covtypesparse_0->vals);
  ...
  for (int32_t j_crd = 0; j_crd < vec_rand1_dimension; j_crd++) {
    for (int32_t imtx_covtypesparse_0_pos = mtx_covtypesparse_02_pos[j_crd]; imtx_covtypesparse_0_pos < mtx_covtypesparse_02_pos[(j_crd + 1)]; imtx_covtypesparse_0_pos++) {
      int32_t i_crd = mtx_covtypesparse_02_crd[imtx_covtypesparse_0_pos];
      out_vals[i_crd] = out_vals[i_crd] + mtx_covtypesparse_0_vals[imtx_covtypesparse_0_pos] * vec_rand_vals[j_crd];
    }
  }
