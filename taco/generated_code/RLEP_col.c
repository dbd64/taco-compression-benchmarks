...
int compute(taco_tensor_t *out, taco_tensor_t *mtx_covtyperlep_0, taco_tensor_t *vec_rand) {
  ...
  for (int32_t j_crd = 0; j_crd < vec_rand1_dimension; j_crd++) {
    ...
    while (imtx_covtyperlep_0_pos < pmtx_covtyperlep_02_end) {
      ...
      if (headerByte > header_mid+1) {
        header_type mtx_covtyperlep_02_run = header_max - headerByte;
        // __builtin_assume(mtx_covtyperlep_02_run <= header_mid+1);

        int32_t mtx_covtyperlep_0_fill_value = ((int32_t*)(&(vals[(imtx_covtyperlep_0_pos + headerSize)])))[0];
        imtx_covtyperlep_0_pos += sizeof(int32_t) + headerSize;
        ...
        header_type mtx_covtyperlep_02_found_cnt = headerByte + 1;
