...
int compute(taco_tensor_t *out, taco_tensor_t *mtx_mnistdense_0, taco_tensor_t *vec_rand) {
  int32_t* restrict out_vals = (int32_t*)(out->vals);
  int out1_dimension = (int)(out->dimensions[0]);
  int mtx_mnistdense_01_dimension = (int)(mtx_mnistdense_0->dimensions[0]);
  int mtx_mnistdense_02_dimension = (int)(mtx_mnistdense_0->dimensions[1]);
  int32_t* restrict mtx_mnistdense_0_vals = (int32_t*)(mtx_mnistdense_0->vals);
  ...
  for (int32_t i_crd = 0; i_crd < mtx_mnistdense_01_dimension; i_crd++) {
    int32_t tjout_val = 0;
    for (int32_t j_crd = 0; j_crd < vec_rand1_dimension; j_crd++) {
      int32_t jmtx_mnistdense_0_pos = i_crd * mtx_mnistdense_02_dimension + j_crd;
      tjout_val += mtx_mnistdense_0_vals[jmtx_mnistdense_0_pos] * vec_rand_vals[j_crd];
    }
