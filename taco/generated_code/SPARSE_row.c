...
int compute(taco_tensor_t *out, taco_tensor_t *mtx_mnistsparse_0, taco_tensor_t *vec_rand) {
  int out1_dimension = (int)(out->dimensions[0]);
  int32_t* restrict out_vals = (int32_t*)(out->vals);
  int mtx_mnistsparse_01_dimension = (int)(mtx_mnistsparse_0->dimensions[0]);
  int* restrict mtx_mnistsparse_02_pos = (int*)(mtx_mnistsparse_0->indices[1][0]);
  int* restrict mtx_mnistsparse_02_crd = (int*)(mtx_mnistsparse_0->indices[1][1]);
  int32_t* restrict mtx_mnistsparse_0_vals = (int32_t*)(mtx_mnistsparse_0->vals);
  ...
  for (int32_t i_crd = 0; i_crd < mtx_mnistsparse_01_dimension; i_crd++) {
    int32_t tjout_val = 0;
    for (int32_t jmtx_mnistsparse_0_pos = mtx_mnistsparse_02_pos[i_crd]; jmtx_mnistsparse_0_pos < mtx_mnistsparse_02_pos[(i_crd + 1)]; jmtx_mnistsparse_0_pos++) {
      int32_t j_crd = mtx_mnistsparse_02_crd[jmtx_mnistsparse_0_pos];
      tjout_val += mtx_mnistsparse_0_vals[jmtx_mnistsparse_0_pos] * vec_rand_vals[j_crd];
    }
