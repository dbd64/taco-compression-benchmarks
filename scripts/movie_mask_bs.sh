...
out=/data/scratch/danielbd/taco-compression-benchmarks2/out/mask_frame_2/bs/
validation=/data/scratch/danielbd/taco-compression-benchmarks2/out/mask_frame_2/bs/validation/
mkdir -p "$out"
mkdir -p "$validation"
