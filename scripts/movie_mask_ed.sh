...
out=/data/scratch/danielbd/taco-compression-benchmarks2/out/mask_frame_2/ed/
validation=/data/scratch/danielbd/taco-compression-benchmarks2/out/mask_frame_2/ed/validation/
mkdir -p "$out"
mkdir -p "$validation"
