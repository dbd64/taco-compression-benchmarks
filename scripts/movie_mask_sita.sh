...
out=/data/scratch/danielbd/taco-compression-benchmarks2/out/mask_frame_2/sita/
validation=/data/scratch/danielbd/taco-compression-benchmarks2/out/mask_frame_2/sita/validation/
mkdir -p "$out"
mkdir -p "$validation"
